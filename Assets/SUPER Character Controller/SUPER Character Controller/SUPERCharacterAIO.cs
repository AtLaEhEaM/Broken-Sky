...
public class SUPERCharacterAIO : MonoBehaviour{
    ...
    [Range(1.0f,6500.0f)]public float walkingSpeed = 140, sprintingSpeed = 260, crouchingSpeed = 45;
    [Range(1.0f,4000.0f)] public float decelerationSpeed=240;
    #if ENABLE_INPUT_SYSTEM
    ...
    #endif
    [Range(1.0f,6500.0f)] public float jumpPower = 6500
            ;
